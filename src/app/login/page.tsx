  ...
  return (
    <div className="min-w-full h-screen flex flex-col">
      ...
      <div className="flex flex-col justify-center xl:mx-96 border dark:border-gray-500 rounded-sm mt-1 md:h-[450px] items-center ">
        <h1 className="mx-10 md:mx-44 text-center text-2xl underline italic">Bem-vindo ao Diario Alerta!</h1>
        <h1 className="mx-10 md:mx-44 lg:mx-80 mt-2 text-center">
      ...
      <h1 className="mt-2 mb-2 text-center text-lg font-semibold">Antoniocarlosjr007@hotmail.com</h1>
      </div>
    </div>
  );
}
